...
$product = $mysqli->query('SELECT * FROM `products` where `id`=' . $_GET['id'] . ' ');
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group mt-4">
                        ...
                        <input type="number" min="1.00" name="price" class="form-control" required value="<?= $result->price ?>">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group mt-4">
                        <label for="">UPC</label>
                        <input type="text" name="upc" class="form-control" required value="<?= $result->upc ?>">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group mt-4">
                ...
                <div class="col">
                    <div class="form-group mt-4">
                        ...
                        <img src="uploads/<?= $result->image ?>" alt="" width="100%">
